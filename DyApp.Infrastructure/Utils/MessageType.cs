...
namespace DyApp.Infrastructure.Utils
{
    public class MessageType
    {
        ...
        public const string EVENT_TYPE_SCAN = "scan";
        // 事件类型：LOCATION(上报地理位置)
        public const string EVENT_TYPE_LOCATION = "LOCATION";
        // 事件类型：CLICK(自定义菜单)
        public const string EVENT_TYPE_CLICK = "CLICK";
        // 响应消息类型：文本
        public const string RESP_MESSAGE_TYPE_TEXT = "text";
        // 响应消息类型：图片
        public const string RESP_MESSAGE_TYPE_IMAGE = "image";
        // 响应消息类型：语音
        public const string RESP_MESSAGE_TYPE_VOICE = "voice";
        // 响应消息类型：视频
        public const string RESP_MESSAGE_TYPE_VIDEO = "video";
        // 响应消息类型：音乐
